...
use async_graphql::{connection::{Connection, Edge, query}, Context,
                    Enum, Error, Interface, Object, OutputType, Result};
use slab::Slab;
...
pub struct StarWarsChar {
    ...
    pub(crate) friends: Vec<usize>,
    pub(crate) appears_in: Vec<Episode>,
    pub(crate) home_planet: Option<&'static str>,
    pub(crate) primary_function: Option<&'static str>,
}

pub struct StarWars {
    pub(crate) luke: usize,
    pub(crate) artoo: usize,
    pub(crate) chars: Slab<StarWarsChar>,
    pub(crate) chars_by_id: HashMap<&'static str, usize>,
}
